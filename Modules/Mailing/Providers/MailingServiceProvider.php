...
class MailingServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'mailing'
        );
    }
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'mailing');
    }
    ...
    {
        $langPath = resource_path('lang/modules/mailing');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'mailing');
        } else {
